...
const projects = [
  ...
  },
  {
    ...
    description: "Landing page for a laboratory management system with a focus on user experience and accessibility.",
  ...
  },
  {
    ...
    description: "Prototype for a flight booking system with a focus on user experience and accessibility.",
    image: "/projects/flight-booking.png",
    tech: ["HTML", "CSS", "Bootstrap", "JavaScript", "Node.js", "Express", "MongoDB", "React"],
  ...
  {
    title: "Hedwig - AI Study Buddy",
    description: "A full-stack application that leverages AI to assist students in their studies.",
    image: "/projects/hedwig.png",
    tech: ["MongoDB", "Express", "React", "TypeScript", "Vite", "Node.js", "Tailwind CSS", "CSS"],
    github: "https://github.com/AlvinJohnB/AIStudyBuddy",
    demo: "https://hedwig.ajbregs.com/",
  },
];
...
export default function Home() {
  return (
    <div className="min-h-screen">
      {/* Landing Section */}
      <section id="landing" className="container grid grid-cols-1 lg:grid-cols-3 gap-8 px-5 mx-auto min-h-screen py-12">
        <div className="col-span-2 lg:my-auto px-5 lg:order-1 order-2">
          <TypingText />
          <div className="mt-6 space-y-4">
            <p className="text-lg leading-relaxed">
              I&apos;m passionate in building functional, user-friendly applications. With experience in React.js,
              Node.js, and MongoDB/MySQL, I specialize in creating full-stack solutions—from mobile apps to modern web
              systems. I enjoy solving real-world problems with clean, scalable code. I&apos;m always learning, always
              building, and always up for the next challenge. Let&apos;s create something awesome together.
            </p>
            <p className="text-lg">Welcome to my portfolio — feel free to explore my work!</p>
          </div>
        </div>
      ...
      <section id="projects" className="py-20 px-6 lg:px-8 relative z-10">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl lg:text-4xl font-light foreground mb-4">Featured Projects</h2>
            <p className="text-muted-foreground text-lg">A showcase of my recent work and achievements</p>
          </div>
      ...
      <section id="tools" className="py-20 px-6 lg:px-8 relative z-10">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl lg:text-4xl font-light text-foreground mb-4">Tools & Technologies</h2>
            <p className="text-muted-foreground text-lg">Technologies I work with to bring ideas to life</p>
          </div>
            ...
            {technologies.map((tool, index) => (
              ...
              >
                <CardContent className="p-6 text-center">
                  <Image src={tool.icon} alt={tool.name} width={45} height={45} className="w-full h-25" />

                  <h3 className="text-foreground font-medium mb-2 text-sm">{tool.name}</h3>
                </CardContent>
              </Card>
            ))}
          </div>
      ...
      <section id="contact" className="py-20 px-6 lg:px-8 relative z-10">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl lg:text-4xl font-light text-foreground mb-4">Get In Touch</h2>
          ...
          <div className="grid md:grid-cols-2 gap-12">
            {/* Contact Info */}
            <div>
              <h3 className="text-xl font-medium text-foreground mb-6">Let&apos;s Connect</h3>
